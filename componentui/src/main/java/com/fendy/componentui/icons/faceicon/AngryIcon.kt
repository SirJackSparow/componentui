...
public val AngryIcon: ImageVector
    get() {
        if (_angryicon != null) {
            return _angryicon!!
        }
        _angryicon = ImageVector.Builder(
            name = "EmojiAngry",
            defaultWidth = 16.dp,
            defaultHeight = 16.dp,
            viewportWidth = 16f,
            ...
            path(
                ...
                arcToRelative(0.5f, 0.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, 0.448f, 0.894f)
                ...
                arcToRelative(0.502f, 0.502f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.166f, -0.761f)
                close()
                moveToRelative(-6.552f, 0f)
                arcToRelative(0.5f, 0.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.448f, 0.894f)
                lineToRelative(1.009f, 0.504f)
                arcTo(1.94f, 1.94f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5f, 6.5f)
                curveTo(5f, 7.328f, 5.448f, 8f, 6f, 8f)
                reflectiveCurveToRelative(1f, -0.672f, 1f, -1.5f)
                curveToRelative(0f, -0.247f, -0.04f, -0.48f, -0.11f, -0.686f)
                arcToRelative(0.502f, 0.502f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.166f, -0.761f)
                close()
            }
        }.build()
        return _angryicon!!
...
private var _angryicon: ImageVector? = null
