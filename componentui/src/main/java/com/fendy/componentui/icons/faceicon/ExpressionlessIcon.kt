...
public val ExpressionlessIcon: ImageVector
    get() {
        if (_expressionlessicon != null) {
            return _expressionlessicon!!
        }
        _expressionlessicon = ImageVector.Builder(
...
private var _expressionlessicon: ImageVector? = null
